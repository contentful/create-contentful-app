...
module.exports = async function createAppDefition(appDefinitionSettings = {}) {
  ...
  try {
    ...
    console.log();
    console.log(`Success! Created an app definition for ${appName} in ${selectedOrg.name}`);
    console.log();
    console.log();
    console.log(
      `To update this app definition, open: https://app.contentful.com/account/organizations/${organizationId}/apps/definitions/${createdAppDefition.sys.id}/`
    );
    console.log();
    console.log();
    ...
    console.log();
    console.log(
      'Something went wrong when creating app definition. Run `create-contentful-app create-definition` to try again.'
    );
    console.log();
    console.log(err.message);
    process.exit(1);
