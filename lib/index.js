...
function onSuccess(spinner, folder) {
  ...
  console.log();
  console.log(`Success! Created "${folder}" in ~/${folder}.`);
  console.log();
...
(async function main() {
  ...
  function printHelpText() {
    ...
    console.log(
      `   Paste your access token after obtaining it and select which organization app definition should be installed in`
    );
    console.log();
  }
